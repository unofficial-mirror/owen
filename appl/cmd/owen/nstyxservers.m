Styxservers: module
{
	PATH: con "/dis/owen/nstyxservers.dis";
	...
	Styxserver: adt {
		...
		fidlock:	chan of int;
		ingroup:	ref fn(srv: ref Styxserver, fid: ref Fid, g: string): int;
	...
	openok:	fn(srv: ref Styxserver, fid: ref Fid, omode, perm: int, fuid, fgid: string): int;
